...
import com.sso.cas.custom.action.ValidateLoginAction;
...
public class CustomerAuthWebflowConfiguration implements CasWebflowExecutionPlanConfigurer {
    ...
    public CasWebflowConfigurer customWebflowConfigurer() {
        // 实例化自定义的表单配置类
        final CustomDefaultLoginWebflowConfigurer c = new CustomDefaultLoginWebflowConfigurer(flowBuilderServices, loginFlowDefinitionRegistry,
